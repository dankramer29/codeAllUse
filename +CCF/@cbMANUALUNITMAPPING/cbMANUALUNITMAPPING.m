classdef cbMANUALUNITMAPPING < util.Structable
    ...
    methods
        function this = cbMANUALUNITMAPPING(root)
            basic_nodes = {'Override','Phi','Valid'};
        ...
        end % END function cbMANUALUNITMAPPING
    end % END methods
    
end % END classdef cbMANUALUNITMAPPING