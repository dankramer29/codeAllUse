...
%Example:
% [ statsT, split_corrT, fitresults, gof ] = Analysis.ArtSens.jnd_2to100( freqEM );
...
[fitresults{1},gof{1}] = Analysis.ArtSens.fitPsych2AFC(stats(:,1), stats(:,2));
[fitresults{2},gof{2}] = Analysis.ArtSens.fitPsych2AFC(stats(:,1), stats(:,3));
[fitresults{3},gof{3}] = Analysis.ArtSens.fitPsych2AFC(stats(:,1), stats(:,4));
